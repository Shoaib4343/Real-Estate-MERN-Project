...
const Register = () => {
  ...
  const handleInputChange = (e) => {
    ...
    // Reset error message for the field that is changed
    setFormErrors({
      ...formErrors,
      [name]: '',
    });
        ...
        >
          ...
          <div className="relative">
            ...
            <input
              ...
              value={formData.username}
              onChange={handleInputChange}
              className={`mt-2 block w-full px-4 py-2 border ${formErrors.username ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200`}
              placeholder="Enter your username"
            />
            {formErrors.username && (
          ...
          <div className="relative">
            ...
            <input
              ...
              value={formData.email}
              onChange={handleInputChange}
              className={`mt-2 block w-full px-4 py-2 border ${formErrors.email ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200`}
              placeholder="Enter your email"
            />
            {formErrors.email && (
          ...
          <div className="relative">
            ...
            <input
              ...
              value={formData.password}
              onChange={handleInputChange}
              className={`mt-2 block w-full px-4 py-2 border ${formErrors.password ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200`}
              placeholder="Enter your password"
            />
            {formErrors.password && (
