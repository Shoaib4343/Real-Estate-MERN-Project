...
import { Link } from "react-router-dom"; // Import Link to use internal routing links

const Footer = () => {
  return (
    <div className="bg-[#0F0E0E] relative mt-4 ">
      <div className="max-w-screen-2xl mx-auto pt-20 px-5">
        <footer className="text-white py-10">
          <div className="flex flex-col lg:flex-row gap-10 flex-wrap justify-between lg:gap-20">
            ...
            <div className="flex-1 sm:w-full">
              ...
              <form className="flex items-center overflow-hidden">
                ...
                />
                <button type="submit" className="text-white border border-[#FF5B28] ml-2 px-4 py-2 transition">
                  Subscribe
                </button>
              </form>
            </div>
            ...
            <div className="flex-1 sm:w-full">
              ...
              <ul className="text-gray-400 text-sm space-y-2">
                ...
                <li>
                  <Link to="/about" className="hover:text-[#FF5B28]">
                    About us
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="hover:text-[#FF5B28]">
                    Contact
                  </Link>
                </li>
               
                <li>
                  <Link to="/list" className="hover:text-[#FF5B28]">
                    Properties
                  </Link>
                </li>
            ...
            <div className="flex-1 sm:w-full">
              ...
              <p className="text-gray-400 text-sm mb-4">+92 333 3331234</p>
              <p className="text-gray-400 text-sm mb-4">findHome@gmail.com</p>
          ...
          <p className="text-sm text-center mt-16">
            2024 &copy; Design Find Home. All rights reserved.
          </p>
        </footer>
      </div>
    </div>
